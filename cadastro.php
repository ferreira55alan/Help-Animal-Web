...
<html class="nojs html" lang="pt-BR">
 <head>
  ...
  <script type="text/javascript">
   if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["jquery-1.8.3.min.js", "museutils.js", "jquery.watch.js", "cadastro.css"], "outOfDate":[]};
</script>
  ...
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="muse/CSS/site_global.css"/>
  <link rel="stylesheet" type="text/css" href="muse/CSS/master_a-mestre.css"/>
  <link rel="stylesheet" type="text/css" href="application/assets/cadastro.css" id="pagesheet"/>
  <!-- Other scripts -->
  <script type="text/javascript">
   ...
   <div class="clearfix grpelem" id="u1757"><!-- column -->
    <div class="clearfix colelem" id="u1397"><!-- group -->
     ...
     <div class="grpelem" id="u1304"><!-- simple frame --></div>
       ...
       <a class="nonblock nontext clip_frame colelem" id="u1367" href="index.php"><!-- image --><img class="block" id="u1367_img" src="muse/images/logo help animails cor.png" alt="" dataimage-width="188" data-image-height="85"/></a>
    <div class="colelem" id="u1576"><!-- custom html -->
        <link rel = "stylesheet" type = "text/css" href = "application/assets/cadastrousu.css">
<div class="card">
            <h3><li>
<b> CADASTRO </b>
            </li></h3>
